...
export const metadata: Metadata = {
  ...
  keywords: "lịch âm, lịch dương, ngày tốt, giờ hoàng đạo, tiết khí, can chi, trực, chuyển đổi lịch",
  authors: [{ name: "Calendar Next" }],
  robots: "index, follow",
  openGraph: {
    title: "Lịch Âm Dương - Xem Ngày Tốt, Giờ Hoàng Đạo",
    description: "Lịch âm dương Việt Nam chính xác, xem ngày tốt, giờ hoàng đạo, hắc đạo, tiết khí, trực.",
    type: "website",
    locale: "vi_VN",
  },
};
