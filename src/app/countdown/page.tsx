              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-3 text-neutral-600">
                  <p>
                    ...
                    đánh dấu sự khởi đầu của năm mới theo âm lịch.
                  </p>
                  <p>
                    Đây là thời gian để gia đình sum họp, tôn vinh tổ tiên, và cầu chúc 
                    một năm mới an khang, thịnh vượng.
                  </p>
                  <p>
                    Tết thường kéo dài 3 ngày chính thức, nhưng không khí lễ hội có thể 
                    kéo dài cả tháng giêng.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-neutral-600">
                <div className="flex items-start">
                  ...
                  <span>Tết có thể rơi vào khoảng từ 21/1 đến 20/2 dương lịch</span>
                </div>
                <div className="flex items-start">
                  <i className="fas fa-clock text-accent mr-2 mt-1"></i>
                  <span>Giao thừa là thời khắc chuyển giao giữa năm cũ và năm mới</span>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <span>Hoa mai (miền Nam) và hoa đào (miền Bắc) là biểu tượng của Tết</span>
                </div>
              </div>
            </div>
          </div>
